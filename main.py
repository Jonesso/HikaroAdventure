...
while True:  # game loop
    ...
    player.tile_rects = level_map.blit_all_tiles(display, player.scroll)
    all_sprites.update()

    for sprite in all_sprites:
        display.blit(pg.transform.flip(sprite.image, player.flip, False),
                     (player.rect.x - player.scroll[0], player.rect.y - player.scroll[1]))
